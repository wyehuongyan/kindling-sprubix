//
//  SellerAgreementViewController.swift
//  Sprubix
//
//  Created by Shion Wah on 14/11/15.
//  Copyright (c) 2015 Sprubix. All rights reserved.
//

import UIKit

class SellerAgreementViewController: UIViewController, UIWebViewDelegate {
    
    var webView: UIWebView!
    let webURL: NSURL = NSURL(string: "http://www.sprubix.com/seller-agreement")!
    ...
    func initNavBar() {
        ...
        newNavItem.title = "Seller Agreement"
